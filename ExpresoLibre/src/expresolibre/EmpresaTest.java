...
public class EmpresaTest {
	...
	@Test(expected = RuntimeException.class)
	public void testIniciarViajeDeTransporteNoRegistrado() throws Exception {
		emp.iniciarViaje("AC314PI");
	}
	
	@Test(expected = RuntimeException.class)
	public void testIniciarViajeSinCarga() throws Exception {
		emp.agregarTrailer("AC314PI", 12000, 60, true, 5, 100);
		emp.iniciarViaje("AC314PI");
	}
	
	@Test(expected = RuntimeException.class)
	public void testFinalizarViajeNoIniciado() throws Exception {
		emp.agregarTrailer("AC314PI", 12000, 60, true, 5, 100);
